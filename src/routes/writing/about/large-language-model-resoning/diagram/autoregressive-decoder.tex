...
\begin{tikzpicture}[node distance=30pt and 20pt, >=Stealth, thick,
    ...
    input/.style={fill=green!40, text=black},
    output/.style={fill=red!40, text=black},
    hidden/.style={fill=gray!40, text=black},
    attention/.style={->, draw=white!70, thick, bend left},
...
\draw[attention] (l1h1) to[out=00, in=180] (l2h1);
\draw[attention] (l1h2) to[out=00, in=180] (l2h2);
\draw[attention] (l1h3) to[out=00, in=180] (l2h3);
\draw[attention] (l1h4) to[out=00, in=180] (l2h4);
...
\draw[attention] (l2h1) to[out=00, in=180] (l3h1);
\draw[attention] (l2h2) to[out=00, in=180] (l3h2);
\draw[attention] (l2h3) to[out=00, in=180] (l3h3);
\draw[attention] (l2h4) to[out=00, in=180] (l3h4);
...
\draw[attention] (l3h1) to[out=00, in=180] (l4h1);
\draw[attention] (l3h2) to[out=00, in=180] (l4h2);
\draw[attention] (l3h3) to[out=00, in=180] (l4h3);
\draw[attention] (l3h4) to[out=00, in=180] (l4h4);
