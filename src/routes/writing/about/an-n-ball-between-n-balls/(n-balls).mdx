...
[Here is a Desmos calculator interactable](https://www.desmos.com/calculator/osvrtc1t9m) that visualises a 2D slice of the 10D construct. Notice how much empty space there is between the balls.
